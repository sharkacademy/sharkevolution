...
function addBooks() {
    catalog.push(
        ...
        { title: "O Senhor dos Aneis", author: "J.R.R. Tolkien", genre: "Aventura", publishingYear: 1954, pages: 1216, available: true },
    ...
    while (option !== 5) {
        ...
        if (option === 1) {
            ...
            for (let genre in bookGenres) {
                message2 += genre.toUpperCase() + ": " + bookGenres[genre] + "\n";
            }
