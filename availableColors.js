...
let userInput = prompt("Enter three colors to check, separated by commas:"); // "red, pink, grey"
let userColors = userInput.split(",").map(color => color.trim().toLowerCase()); // [red, pink, grey]
